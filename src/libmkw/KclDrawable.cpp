...
#include "kcl_shader_info.hpp" // generated by CSP
...
const csp::ProgramDescriptor& KclDrawable::programDescriptor() const {
    return kcl_descriptor;
}
...
void KclDrawable::processData() {
    ...
    for (const auto& prism : m_prisms) {
        ...
        // Add the vertices to the triangle list (reversed winding order)
